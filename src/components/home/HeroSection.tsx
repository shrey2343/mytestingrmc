    ...
    >
      ...
      <div className="container-custom relative z-20 w-full py-8 md:py-12 lg:py-16 flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16">
        ...
        >
          ...
          <motion.h1 
            className="font-display font-bold text-[46px] xs:text-[48px] sm:text-[50px] md:text-[54px] lg:text-[62px] leading-[1.25] mb-4 md:mb-6 text-center lg:text-left max-w-full px-3"
          ...
          <motion.p 
            className="font-body text-[20px] sm:text-[22px] md:text-xl lg:text-2xl leading-relaxed text-slate-300 mb-6 md:mb-8 text-center lg:text-left px-2"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
